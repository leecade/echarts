...
Base.prototype.brush = function (ctx, isHighlight) {
    ...
    if (isHighlight) {
        ...
        style, this.highlightStyle || {}, this.brushTypeOnly);
    }
...
Base.prototype.getHighlightStyle = function (style, highlightStyle, brushTypeOnly) {
    ...
    if (style.brushType != 'stroke') {
        ...
        if (brushTypeOnly != 'stroke') {
            ...
            style.strokeColor, color.toRGB(highlightColor));
        }
    }
...
/*
    ...
    if (tx != null && ty != null) {
        _fillText(
        ctx, style.text, tx, ty, style.textFont, style.textAlign || al, style.textBaseline || bl);
    }
};
// TODO
Base.prototype.isSilent = function () {
    return !(
    this.hoverable || this.draggable || this.onmousemove || this.onmouseover || this.onmouseout || this.onmousedown || this.onmouseup || this.onclick || this.ondragenter || this.ondragover || this.ondragleave || this.ondrop);
};
