 ...
 * @example
 *   var Heart = require('zrender/shape/Heart.js');
 *   var shape = new Heart({
 *       style: {
 *           x: 100,
 *           y: 100,
...
Heart.prototype = {
    ...
    buildPath: function (ctx, style) {
        ...
        path.bezierCurveTo(
        style.x + style.a / 2, style.y - style.b * 2 / 3, style.x + style.a * 2, style.y + style.b / 3, style.x, style.y + style.b);
        path.bezierCurveTo(
        style.x - style.a * 2, style.y + style.b / 3, style.x - style.a / 2, style.y - style.b * 2 / 3, style.x, style.y);
        path.closePath();
        return;
    },
