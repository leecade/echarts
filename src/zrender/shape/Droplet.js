 ...
 * @example
 *   var Droplet = require('zrender/shape/Droplet.js');
...
Droplet.prototype = {
    ...
    buildPath: function (ctx, style) {
        ...
        path.bezierCurveTo(
        style.x + style.a, style.y + style.a, style.x + style.a * 3 / 2, style.y - style.a / 3, style.x, style.y - style.b);
        path.bezierCurveTo(
        style.x - style.a * 3 / 2, style.y - style.a / 3, style.x - style.a, style.y + style.a, style.x, style.y + style.a);
        path.closePath();
    },
