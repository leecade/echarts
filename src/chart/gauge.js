...
Gauge.prototype = {
    ...
    _buildAxisLine: function (seriesIndex) {
        ...
        for (var i = 0, l = colorArray.length; i < l; i++) {
            ...
            center, r0, r, newAngle, // startAngle
            lastAngle, // endAngle
    ...
    _buildPointer: function (seriesIndex) {
        ...
        ecData.pack(
        pointShape, this.series[seriesIndex], seriesIndex, this.series[seriesIndex].data[0], 0, this.series[seriesIndex].data[0].name, value);
