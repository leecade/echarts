...
var eventRiverLayout = require('../layout/eventRiver.js');
...
EventRiver.prototype = {
    ...
    _buildShape: function () {
        ...
        eventRiverLayout(
        eventRiverSeries, this._intervalX, this.component.grid.getArea());
    ...
    _drawEventBubble: function (oneEvent, seriesIndex, dataIndex) {
        ...
        emphasis.color, seriesIndex, dataIndex, data) || (typeof normalColor === 'string' ? zrColor.lift(normalColor, -0.2) : normalColor);
        ...
        ecData.pack(
        eventBubbleShape, series[seriesIndex], seriesIndex, series[seriesIndex].eventList[dataIndex], dataIndex, series[seriesIndex].eventList[dataIndex].name);
...
// 图表注册
require('../chart.js').define('eventRiver', EventRiver);
