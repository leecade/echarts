...
Legend.prototype = {
    ...
    _buildItem: function () {
        ...
        for (var i = 0; i < dataLength; i++) {
            ...
            lastX, lastY, itemWidth, itemHeight, (this._selectedMap[itemName] ? color : '#ccc'), itemType, color);
    ...
    _getItemShapeByType: function (x, y, width, height, color, itemType, defaultColor) {
        ...
        case 'k':
            ...
            itemShape.style.color = this.query(this.ecTheme, 'k.itemStyle.normal.color') || '#fff';
        ...
        if (newOption) {
            ...
            for (var i = 0, dataLength = data.length; i < dataLength; i++) {
                ...
                if (!something.series) {
                    ...
                    typeof this._selectedMap[itemName] != 'undefined' ? this._selectedMap[itemName] : true;
                }
            }
        }
        this.clear();
