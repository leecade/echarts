...
DataRange.prototype = {
    ...
    _buildItem: function () {
        ...
        if (this.dataRangeOption.text) {
            ...
            if (this.dataRangeOption.text[0]) {
                ...
                if (this.dataRangeOption.orient == 'horizontal') {
                    ...
                    this.dataRangeOption.text[0], font) + this._textGap;
                }
                else {
        ...
        for (var i = 0; i < dataLength; i++) {
            ...
            lastX, lastY, itemWidth, itemHeight, (this._selectedMap[i] ? color : '#ccc'));
            itemShape._idx = i;
        ...
        if (this.dataRangeOption.orient == 'horizontal') {
            itemShape = {
                ...
                style: {
                    ...
                    lastX, lastY, lastX + itemWidth * mSize, lastY, colorList)
                },
                hoverable: false
            };
            ...
            itemShape = {
                ...
                style: {
                    ...
                    color: zrColor.getLinearGradient(
                    lastX, lastY, lastX, lastY + itemHeight * mSize, colorList)
                },
                hoverable: false
            };
    ...
    _bulidHandle: function () {
        ...
        zrArea.getTextWidth(this._textFormat(this.dataRangeOption.max), font), zrArea.getTextWidth(this._textFormat(this.dataRangeOption.min), font)) + 2;
    ...
    _getItemGroupLocation: function () {
        ...
        if (this.dataRangeOption.orient == 'horizontal') {
            ...
            if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) {
                // 指定文字或线性渐变
                totalWidth = ((this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) ? (itemWidth * mSize + itemGap) : dataLength * (itemWidth + itemGap)) + (this.dataRangeOption.text && typeof this.dataRangeOption.text[0] != 'undefined' ? (zrArea.getTextWidth(
                this.dataRangeOption.text[0], font) + this._textGap) : 0) + (this.dataRangeOption.text && typeof this.dataRangeOption.text[1] != 'undefined' ? (zrArea.getTextWidth(
                this.dataRangeOption.text[1], font) + this._textGap) : 0);
            }
            else {
                // 值标签
                itemWidth += 5;
            ...
            if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) {
                ...
                maxWidth = Math.max(
                zrArea.getTextWidth((this.dataRangeOption.text && this.dataRangeOption.text[0]) || '', font), zrArea.getTextWidth((this.dataRangeOption.text && this.dataRangeOption.text[1]) || '', font));
        ...
        if (this.dataRangeOption.calculable) {
            ...
            zrArea.getTextWidth(this.dataRangeOption.max, font), zrArea.getTextWidth(this.dataRangeOption.min, font)) + textHeight;
            if (this.dataRangeOption.orient == 'horizontal') {
                if (x < handlerWidth) {
                    x = handlerWidth;
                }
    ...
    _syncShape: function () {
        ...
        this._startShape.style.x - this._startShape.style._x, this._startShape.style.y - this._startShape.style._y];
        ...
        this._endShape.style.x - this._endShape.style._x, this._endShape.style.y - this._endShape.style._y];
    ...
    _dispatchDataRange: function () {
        ...
        ecConfig.EVENT.DATA_RANGE, null, {
            range: {
    ...
    __dataRangeSelected: function (param) {
        ...
        this.messageCenter.dispatch(
        ecConfig.EVENT.DATA_RANGE_SELECTED, param.event, {
    ...
    __dispatchHoverLink: function (param) {
        ...
        this.messageCenter.dispatch(
        ecConfig.EVENT.DATA_RANGE_HOVERLINK, param.event, {
            valueMin: valueMin,
            valueMax: valueMax
        }, this.myChart);
    ...
    refresh: function (newOption) {
        if (newOption) {
            ...
            this.dataRangeOption.color, Math.max((splitNumber - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1), 0) + 1);
            ...
            for (var i = 0; i < splitNumber; i++) {
                ...
                this._textFormat(
                i * this._gap + this.dataRangeOption.min, (i + 1) * this._gap + this.dataRangeOption.min));
            }
        }
