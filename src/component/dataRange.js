        ...
        if (this.dataRangeOption.orient == 'horizontal') {
            itemShape = {
                ...
                style: {
                    ...
                    lastX, lastY, lastX + itemWidth * 10, lastY, colorList)
                },
                hoverable: false
            };
            ...
            itemShape = {
                ...
                style: {
                    ...
                    color: zrColor.getLinearGradient(
                    lastX, lastY, lastX, lastY + itemHeight * 10, colorList)
                },
                hoverable: false
            };
    ...
    _getItemGroupLocation: function () {
        ...
        if (this.dataRangeOption.orient == 'horizontal') {
            ...
            if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) {
                // 指定文字或线性渐变
                totalWidth = ((this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable) ? (itemWidth * 10 + itemGap) : dataLength * (itemWidth + itemGap)) + (this.dataRangeOption.text && typeof this.dataRangeOption.text[0] != 'undefined' ? (zrArea.getTextWidth(
    ...
    _syncShapeFromRange: function () {
        ...
        if (this._range.start != 100 || this._range.end !== 0) {
            ...
            if (this.dataRangeOption.orient == 'horizontal') {
                ...
                this._fillerShae.style.x += width * (100 - this._range.start) / 100;
                ...
                this._fillerShae.style.y += height * (100 - this._range.start) / 100;
